...
import { aumentarCaixa, carrinho, clearCarrinho, getUsuarioAtual, getUsuarioNeutro, listaNotasFiscais, listaProdutos, listaVendas, retornarCliente, setUsuarioAtual, usuarioAtual } from "../Utils/variaveis";
    ...
    while (menu) {
        ...
        switch (escolha) {
                ...
                if (encontrarPorID(listaProdutos, IDSelecionado) >= 0) {
                    ...
                    while(menuQuant){
                        ...
                        if(quantidadeEscolhida > 0 && quantidadeEscolhida <= quantidadeMaximaPossivel){
                            ...
                            console.log("Não é possivel comprar tantos produtos! [-1 para cancelar]")
            ...
            case 5:
                ...
                if (Comprar == 'sim' && usuarioCliente.dinheiro >= totalCarrinho) {
            ...
            case 6:
                ...
                carrinho.splice(0 ,carrinho.length ,...carrinho.filter((produtoFilter)=>{
                    return produtoFilter.ID !== removeID
                }))
