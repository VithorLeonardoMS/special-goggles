...
export class Cliente {
    ...
    public setCliente(): void {
        ...
        let novoDinheiro = rl.question("Adicione a quantia de dinheiro: \n")

        this.nomeCliente = novoNomeCliente || this.nomeCliente;
        this.enderecoCliente = novoEnderecoCliente || this.enderecoCliente;
        this.eMail = novoEmail || this.eMail;
        this.senhaCliente = novaSenhaCliente || novaSenhaCliente;
        this.dinheiro = Number(novoDinheiro) || this.dinheiro;
    }
