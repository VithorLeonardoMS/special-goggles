...
exports.aumentarCaixa = aumentarCaixa;
...
exports.produtoA = new Produto_1.Produto('Agua do sor leo', 0, 50, 10, 80);
exports.produtoB = new Produto_1.Produto('Cabelo do sor Iuri (edição limitada)', 1, 40, 20, 100);
exports.produtoC = new Produto_1.Produto('Abraço do sor Lucas', 2, 80, 50, 30);
//Produtos pré definidosa
