...
export let produtoA = new Produto('Agua do sor leo', 0, 50, 10, 80                     )
export let produtoB = new Produto('Cabelo do sor Iuri (edição limitada)', 1, 40, 20, 100)
export let produtoC = new Produto('Abraço do sor Lucas',2,80,50,30                            )
...
export function aumentarCaixa(valor:number):void{
    caixaMercado += valor
}
